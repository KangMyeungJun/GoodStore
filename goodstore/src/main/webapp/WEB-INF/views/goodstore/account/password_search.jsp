	...
	<section class="bg0 p-t-104 p-b-116">
		<div class="container bor10">
			<div class="flex-c">
				...
				<div class="p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form>
						...
						<div class="bor8 m-b-20">
							<input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="text" name="name" placeholder="이름">
						</div>
              ...
              <input class="stext-111 cl2 plh3 size-116 p-l-20 p-r-30" type="text" name="email" placeholder="이메일">
						</div>
            ...
            <div class="flex-c-m cl0 size-121 p-lr-15 m-t-50">
              ...
              <a class="m-lr-10 cl2" href="email_search.html">이메일 찾기</a>
            </div>
					</form>
				</div>
			</div>
